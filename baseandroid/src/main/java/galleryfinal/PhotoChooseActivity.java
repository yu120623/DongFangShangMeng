 ...
 */
public abstract class PhotoChooseActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {

    private GridView mGvPhotoList;
    private ListView mLvFolderList;
    private TextView okBtn;
    private RelativeLayout mLllBottomBar;
    ...
    private void findViews() {
        ...
        mLllBottomBar = (RelativeLayout) findViewById(R.id.ll_bottom_bar);
        ...
        okBtn = (TextView) this.findViewById(R.id.ok);
    }
    ...
    public void refreshSelectCount() {
        okBtn.setText("确定"+mSelectPhotoMap.size()+"/"+mLimit);
    }
    ...
    private void getPhotos() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                List<PhotoFolderInfo> allFolderList = PhotoTools.getAllPhotoFolder(context);
